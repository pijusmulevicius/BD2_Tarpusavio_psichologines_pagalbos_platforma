...
class ListenerChatListView extends StatefulWidget {
  ...
  const ListenerChatListView({super.key});

  @override
  _ListenerChatListViewState createState() => _ListenerChatListViewState();
}

class _ListenerChatListViewState extends State<ListenerChatListView> {
